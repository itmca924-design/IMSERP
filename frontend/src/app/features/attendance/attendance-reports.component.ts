...
<div class="report-page">
  ...
  <div class="print-heading"><h2>{{ reportType === 'student' ? 'Student' : 'Teacher' }} Attendance Report</h2><span>{{ months[selectedMonth - 1] }} {{ selectedYear }}</span></div>
